...
CREATE TABLE `person_movies` (
  ...
  KEY `idmovies_idx` (`id_person`,`id_movies`),
  KEY `id_movies_idx` (`id_movies`),
  CONSTRAINT `idm` FOREIGN KEY (`id_movies`) REFERENCES `movies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `idp` FOREIGN KEY (`id_person`) REFERENCES `person` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-01-24 14:54:54
